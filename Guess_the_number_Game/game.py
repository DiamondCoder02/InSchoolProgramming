print("\033c")
import json ; import random ; import os
to_play=1 ; wins1=0 ; wins2=0 ; lose1=0 ; lose2=0 ; what=0 ; win=False ; again = 1
            ...
            while int(mn) < 1:
                while True:
                    try:
                        ...
                        print(lang["enter_valid"])
            num = random.randint(1, int(mn)) ; guess = 0
            while int(guess) != num:
                while True:
                    try:
                ...
                for x in range(trynum1):
                    ...
                    while True:
                        try:
                            ...
                            print(lang["enter_valid"])
                    if int(guess) == 1:
                        minnumber = num+1 #; print("lowering")
                    elif int(guess) == 2:
                        maxnumber = num-1 #; print("Higher")
                    elif int(guess) == 3:
